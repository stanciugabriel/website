...
<img src="./tock.svg" class="rounded" />
...
<img src="./tock-stack.png" class="rounded" />
...
Tock provides two libraries:
  - [`libtock-c`](https://github.com./libtock-c) that is fully supported
  - [`libtock-rs`](https://github.com./libtock-rs) that is in development ⚠️ [^rust_issue]

[^rust_issue]: Due to a Rust [compiler issue](https://github.com./libtock-rs/issues/28), Rust applications are not relocatable. This means that developers have to know at compile time the load addresses for Flash and RAM.
